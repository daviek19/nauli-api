...
class Groups extends REST_Controller
{
    ...
    public function find_by_classification_get()
    {
        $classification_id = (int)$this->get('classification_id');

        log_message("debug", "*********** find_by_classification  {$classification_id} ***********");

        $result = $this->groups_model->get_groups_by_classification("", $classification_id);
