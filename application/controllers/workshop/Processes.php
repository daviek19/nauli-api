...
class Processes extends REST_Controller
{
    ...
    public function index_put()
    {
        ...
        if ($this->processes_model->process_name_exists($data['process_name'], $data['company_id']) == TRUE) {
        ...
        if ($this->processes_model->process_sequence_exists($data['sequence'], $data['company_id']) == TRUE) {
    ...
    public function index_post()
    {
        ...
        if (empty($data['process_id']) || empty($data['process_name']) || empty($data['sequence'])) {

            log_message("debug", "index_post Empty process name or process id or sequence supplied... ");

            return $this->response([
                'response' => $data,
                'status' => FALSE,
                'message' => 'Empty process name or process id or sequence supplied',
                'description' => ''
            ], REST_Controller::HTTP_BAD_REQUEST);
        }
